from listings.models import SlidePics
from rest_framework.response import Response
from rest_framework.views import APIView
from rest_framework.generics import ListAPIView, RetrieveAPIView
from rest_framework import permissions
from .models import Listing
from .serializers import ListingSerializer, SlidePicSerializer, listingDetailSerializer
...
class SlidePicView(ListAPIView):
    permission_classes = (permissions.AllowAny, )
    queryset = SlidePics.objects.all()
    serializer_class = SlidePicSerializer